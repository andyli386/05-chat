...
impl User {
    ...
    pub async fn verify(input: &SiginUser, pool: &PgPool) -> Result<Option<Self>, AppError> {
...
mod tests {
    ...
    async fn create_and_verify_user_should_work() -> Result<()> {
        ...
        let input = CreateUser::new("Vincent Li", "vincent@gmail.com", "helloworld123");
        ...
        let input = SiginUser::new(&input.email, &input.password);
