use crate::{
    ...
    AppState, CreateUser, SiginUser, User,
};
...
mod tests {
    ...
    async fn signup_should_work() -> Result<()> {
        ...
        let input = CreateUser::new("Vincent Li", "vincent@gmail.com", "Abc123");
